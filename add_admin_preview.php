 ...
 <header class="headerback">
   ...
   <!--  preview section    -->
         ...
         <table style="border-style:dotted">
            ...
            <tr>
             <td><img src="img/job.jpg" style="height:100px;width:100px"></td>
             <td><span style="color:white;font-size:30px;"><?php echo $name;?></span><br><span style="font-size:20px;color:grey">ID:<?php echo $id;?></span><br><span style="font-size:20px;color:grey"><?php echo $branch;?></span></td>
             
             </tr>
             
             <tr>
             
                <td colspan="2" style="font-size:20px;color:grey;text-align:justify">Access:<?php echo $description;?></td>
